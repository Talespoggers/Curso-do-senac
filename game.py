...
def explicacao_do_jogo():
    ...
    #regras
    print("1° - Regra: Você podera errar apenas 0 vezes.");
    time.sleep(0);
...
while (True):
    ...
    if (dificuldade > 3 or dificuldade < 0): 
        print(' Escolha apenas dificuldades de 1 a 3\n');
    linha()
